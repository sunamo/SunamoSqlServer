...
public partial class MSStoredProceduresIBase : SqlServerHelper
{
    ...
    {
        return MSStoredProceduresI.ci.SelectCellDataTableShortOneRow(signed, table, ColumnNames.ID, ColumnNames.Name, d);
    }
    ...
    public long Insert5(string table, string nazvySloupcu, params object[] sloupce)
    {
        ...
        SqlCommand comm = new SqlCommand(string.Format(@"INSERT INTO {0} {2} VALUES {1};

SELECT SCOPE_IDENTITY();", table, hodnoty, nazvySloupcu));
        ...
        var result = ExecuteScalarLong(null, comm);
        return result;
    }
    ...
    public long Insert6(string table, string nazvySloupcu, params object[] sloupce)
    {
        ...
        try
        {
            hodnoty = MSDatabaseLayer.GetValues(sloupce);

            comm = new SqlCommand(string.Format(@"INSERT INTO {0} {2} VALUES {1};
SELECT CAST(scope_identity() AS int);", table, hodnoty, nazvySloupcu.Replace("(", "(newid(),")));
    ...
    public int UpdateCutStringValue(string tableName, string sloupecCut, string hodnotaCut, string sloupecID, object hodnotaID)
    {
        ...
        List<string> d = new List<string>(SHSplit.Split(aktual, ","));
        d.Remove(hodnotaCut);
        string save = SHJoin.JoinWithoutTrim(",", d);
