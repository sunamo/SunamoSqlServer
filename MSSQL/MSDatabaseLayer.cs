...
public partial class MSDatabaseLayer //:MSDatabaseLayerBase
{
    ...
    //    AssignConnectionString("Data Source=46.36.38.72;Database=sunamo.cz;User ID=sa;Password="+ AppData.ci.GetCommonSettings(CommonSettingsKeys.pwSql) + ";MultipleActiveResultSets=True" + ";");
    //}
